...
@Service
public class AllComplaintsInfo {
	
	@Autowired
	private RestTemplate restTemplate;
	
	//@HystrixCommand(fallbackMethod = "getFallbackPublicComplaints")
	public FetchComplaints getAllComplaintsInfo() {
		return restTemplate.getForObject("http://localhost:8094/allComplaints", FetchComplaints.class);
	}
